...
# (str) Package name
package.name = shrimp_farming_decision_app
...
source.include_exts = py,kv,png,jpg,jpeg,json,txt,atlas,ttf,otf
...
android.logcat_filters = *:S python:D AndroidRuntime:E ActivityManager:E
