...
class GeneralInfoScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        # Logo
        logo = Image(source='shrimp_logo.jpg', size_hint=(1, 0.4), fit_mode="scale-down")
        ...
        calc_btn = IconButton(icon_source='6633209.png', text="محاسبات")
        ...
        ## Box for History
        hist_btn = IconButton(icon_source='6633209.png', text="تاریخچه")
        ...
        ## Box for About us
        abot_btn = IconButton(icon_source='6633209.png', text="درباره ما")
        ...
        cont_btn = IconButton(icon_source='6633209.png', text="تماس با ما")
